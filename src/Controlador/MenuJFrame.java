...
//crear una instancia de ServiciosJInternalFrame
    ...
    //creamos el JPopupMenu
    JPopupMenu popupMenu = new JPopupMenu();

    //segun el video, se crean los JMenuItem para las opciones del submenu
    JMenuItem opcion1 = new JMenuItem("Equipos Computarizados");
    JMenuItem opcion2 = new JMenuItem("Entregas");
    JMenuItem opcion3 = new JMenuItem("Recepcion");

    //se agregan los JMenuItems al JPopupMenu
    popupMenu.add(opcion1);
    popupMenu.add(opcion2);
    popupMenu.add(opcion3);

    //agregar ActionListener para cada opción
    opcion1.addActionListener(e -> {
        //se crea una instancia de EquipoCompJInternalFrame, ni idea para que
        EquipoCompJInternalFrame frame = new EquipoCompJInternalFrame();
        //agrego la instancia la instancia al escritorio (JDesktopPane)
    ...
    opcion2.addActionListener(e -> {
        // Crear una instancia de EntregaJInternalFrame
        EntregaJInternalFrame frame = new EntregaJInternalFrame();
        // Agregar la instancia al escritorio (JDesktopPane)
        jDesktopPane.add(frame);
        // Hacer visible el internal frame
        frame.setVisible(true);
    ...
    opcion3.addActionListener(e -> {
        // Crear una instancia de RecepcionJInternalFrame
        RecepcionJInternalFrame frame = new RecepcionJInternalFrame();
        // Agregar la instancia al escritorio (JDesktopPane)
        jDesktopPane.add(frame);
        // Hacer visible el internal frame
        frame.setVisible(true);
    ...
    // Mostrar el JPopupMenu en la posición donde se hizo clic en el JLabel
    popupMenu.show(jLabel6, evt.getX(), evt.getY());
